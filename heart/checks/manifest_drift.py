...
the other repo lists against it — Heart's ``config/repos.yaml``, PyAutoHands's
...
# $PYAUTO_ROOT first, then the MAIN checkout — grading reads the canonical
# tree, not a task bundle. See heart/_workspace.py.
